...
def apply_sen2cor(image_path, sen2cor_path, delete_unprocessed_image=False):
    ...
    log.info("calling sen2cor subprocess: {}".format([sen2cor_path, image_path]))
...
def validate_l2_data(l2_SAFE_file, resolution="10m"):
    ...
    # this path stopped working in January 2019, so I have replaced it:
...
def l2_mapping(datadir, mapdir, shapefile, id="map", bands=['B04_10m','B02_10m','B03_10m'], p=None,
