...
@pytest.mark.slow
def test_masked_classification():
    os.chdir(os.path.dirname(os.path.abspath(__file__)))
    try:
        os.remove("test_outputs/class_20180103T172709_20180319T172021.tif")
    except FileNotFoundError:
        pass
    pyeo.classify_image("test_data/T13QFB_20180103T172709_20180329T171921.tif", "test_data/manantlan_v1.pkl",
                        "test_outputs/class_T13QFB_20180103T172709_20180319T172021_masked.tif", num_chunks=4, apply_mask=True)
    image = gdal.Open("test_outputs/class_T13QFB_20180103T172709_20180319T172021_masked.tif")
    assert image
    image_array = image.GetVirtualMemArray()
    assert not np.all(image_array == 0)
