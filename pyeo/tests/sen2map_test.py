...
def map_all_scenes(datadir, id="map", p=None, figsizex=8, figsizey=8, zoom=1, xoffset=0, yoffset=0):
    '''
    function to process the map_it routine for all JPEG files in the Sentinel-2 L2A directory
...
n = map_all_scenes(datadir, id="Overview", p=2, figsizex=12, figsizey=12, zoom=1, xoffset=0, yoffset=0) # overview map
print("Made "+str(n)+" maps.")
n = map_all_scenes(datadir, id="ZoomOut", p=2, figsizex=12, figsizey=12, zoom=2, xoffset=0, yoffset=0) # zoom out
print("Made "+str(n)+" maps.")
n = map_all_scenes(datadir, id="ZoomIn", p=2, figsizex=12, figsizey=12, zoom=0.1, xoffset=0, yoffset=0) # zoom in
print("Made "+str(n)+" maps.")
n = map_all_scenes(datadir, id="MoveLeft", p=2, figsizex=12, figsizey=12, zoom=0.1, xoffset=0, yoffset=-2500) # move left
print("Made "+str(n)+" maps.")
