...
########################
# TODO plot multiple adjacent scenes onto the same map by providing a list of scene IDs to map_L2A_scene
#   instead of rgbdata and running readsen2rgb from within map_L2A_scene
########################
...
def scale_bar_left(ax, bars=4, length=None, location=(0.1, 0.05), linewidth=3, col='black'):
    ...
    File    "/home/h/hb91/PycharmProjects/pyeo/pyeo/sen2map.py", line    831, in map_L2A_scene
